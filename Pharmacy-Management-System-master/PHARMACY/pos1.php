...
<body>
    ...
    <div class="brand-name">SEVA PHARMA</div>
		    ...
		    <p style="margin-top:-20px;color:white;line-height:1;font-size:12px;text-align:center">Developed by, Abhishek Sha, 2021</p>-->
	...
	?>
			...
			<form method="post">
					...
					<input type="number" name="medid" value="<?php echo htmlspecialchars($row4[0] ?? "", ENT_QUOTES); ?>"readonly ><br><br>
					
					<label for="mdname">Medicine Name:</label>
					<input type="text" name="mdname" value="<?php echo htmlspecialchars($row4[1] ?? "", ENT_QUOTES); ?>" readonly><br><br>
					
					</div>
					<div class="column">
					
					<label for="mcat">Category:</label>
					<input type="text" name="mcat" value="<?php echo htmlspecialchars($row4[3] ?? "", ENT_QUOTES); ?>" readonly><br><br>
					
					<label for="mloc">Location:</label>
					<input type="text" name="mloc" value="<?php echo htmlspecialchars($row4[5] ?? "", ENT_QUOTES); ?>" readonly><br><br>
					
					</div>
					<div class="column">
					
					<label for="mqty">Quantity Available:</label>
					<input type="number" name="mqty" value="<?php echo htmlspecialchars($row4[2] ?? "", ENT_QUOTES); ?>" readonly><br><br>
					
					<label for="mprice">Price of One Unit:</label>
					<input type="number" name="mprice" value="<?php echo htmlspecialchars($row4[4] ?? "", ENT_QUOTES); ?>" readonly><br><br>
